...
We want to create a system that allows opticians to quickly prepare and perform an eye examination using a digital chart displayed on a monitor controlled by an Android device.
