...
\caption{The Snellen chart \cite{img_snellen}} \label{fig:snellen_chart}
\end{figure} 
...
\caption{Example of a ETDRS chart. \\ Used with permission, courtesy of Precision Vision \\ (Source: http://precision-vision.com/)\label{fig:etdrs_chart}}
\end{figure} 
