...
\item Display ETDRS 1 Large upper chart from a distance 2 meters

\item Display ETDRS 1 Large lower chart from a distance 2 meters

\item Display HVOT Random chart medium from a distance 1.7 meters

\item Generate a new HVOT chart

\item Display Icons 1 small chart from

\item Page through Icons 1 small chart
