...
\begin{table}[ht!]
\centering
\begin{tabular}{p{3cm} | m{1cm}m{1cm}m{1cm}m{1cm}m{1cm} }
	& &	\multicolumn{2}{c}{Screen}	& 	\multicolumn{2}{c}{Calculated}	\\
\hline
	& row & px & cm & px & cm \\
\hline\hline
\multirow{14}{*}{\parbox{3cm}{\centering Size: 15.6" Resolution: 1920x1080 Distance: 2m}}				
										&	1	&	162	&	2.91	&	c	&	d\\	
										&	2	&	128 & 	2.31	& 	c	&	d\\
		 								&	3	&	102 & 	1.84	& 	c	&	d\\
										&	4	&	81 	& 	1.46	& 	c	&	d\\
										...
										&	14	&	8 	& 	0.15	& 	c	&	d\\
\end{tabular}
\caption{The number of failures and successes during the server detection tests.} \label{tab:optotype_test}
\end{table}
