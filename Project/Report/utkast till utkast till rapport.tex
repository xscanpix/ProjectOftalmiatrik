...
Several pieces of software exists that tries to solve the problems of the physical charts.
%(http://digitaleyechart.com/)
\subsubsection{Digital Eye Chart}
 Digital Eye Chart is a program that attempts to solve the problem of having several charts by using a monitor instead. The user can then, with the help of a computer, change the symbols on the chart and even generate a random chart. 
%http://ichartplus.com/
